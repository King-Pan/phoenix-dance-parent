...
function modifyRole(userId) {
     ...
     * <table id="table"
     ...
     <thead><tr>
     <th data-field="id" data-sortable="true">Item ID</th><th data-field="name" data-sortable="true">Item Name</th>
    ...
    //selectRoleTable.refresh(userId);
}




function initSelectRoleTable(userId) {
